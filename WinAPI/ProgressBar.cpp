...
HRESULT ProgressBar::init(int x, int y, int width, int height)
{
    ...
    _progressBarDown = IMAGEMANAGER->addImage("BarDown", "Resources/Images/Object/BarDown.bmp", 0, 0, width, height, true, RGB(255, 0, 255));
    _progressBarUp = IMAGEMANAGER->addImage("BarUp", "Resources/Images/Object/BarUp.bmp", 0, 0, width, height, true, RGB(255, 0, 255));
